...
private enum AnthropicPrompts {
    ...
    static func toolStep(toolDocs: String, transcript: String) -> String {
        ...
        Call a tool only when its result is needed. The transcript may already include a 当前读到 / 刚读过的上下文 block from the local reader; if that is enough, finish. No other text.
        """
    }
}
