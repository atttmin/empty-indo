...
**系统要求：** Xcode 26+，部署目标 iOS / macOS **26.2**  
...
```bash
git clone https://github.com/<你的用户名>/Empty.git
cd Empty
```
...
```bash
git remote add origin https://github.com/<你的用户名>/Empty.git
git branch -M main
...
```bash
git remote add origin git@github.com:<你的用户名>/Empty.git
git push -u origin main
```
