...
书库、EPUB/PDF 阅读器与「朱 · AI 伴读」侧栏——完整四屏工作流。

![macOS 深读工作台](docs/screenshots/mac-reader.jpg)

### iOS · 书库

暖纸底色书库网格，底部 Tab：书库 / 阅读 / 卡片。

![iOS 书库](docs/screenshots/ios-library.jpg)

### iOS · 阅读 + 朱批 AI

逐段双语、「朱」半屏问书，防剧透 AI 落在页边。

![iOS 阅读与 AI](docs/screenshots/ios-reading.jpg)
